...
export const translations = {
  es: {
    ...
    protectionLevelTitle: 'Tu Nivel de Protección Hoy',
    riskStatusLowText: 'Todo en orden',
    riskStatusMediumText: 'Revisa recomendaciones',
    riskStatusHighText: 'Acción requerida',
    riskStatusUnknownText: 'Desconocido',
    riskStatusLowDesc: 'Tu protección está optimizada según tu perfil actual.',
    riskStatusMediumDesc: 'Revisa estas sugerencias para optimizar tu protección:',
    riskStatusHighDesc: 'Se requiere atención inmediata para mitigar riesgos.',
    riskStatusUnknownDesc: 'No se puede determinar el estado de protección.',
    coverageLevelLabel: 'Nivel de Cobertura Estimado',
    viewRecommendationsButton: 'Ver Recomendaciones',
    simulateProfileButton: 'Simular Otro Perfil',
    improveProtectionButton: 'Mejorar mi Protección',
    currentEnvironmentTitle: 'Entorno Actual',
    weatherLocationText: (location: string) => `en ${location}`,
    yourLocation: 'tu ubicación',
    unknownLocation: 'desconocida',
    weatherUnavailableText: 'Datos de clima no disponibles.',
  ...
  en: {
    ...
    protectionLevelTitle: 'Your Protection Level Today',
    riskStatusLowText: 'All in order',
    riskStatusMediumText: 'Review recommendations',
    riskStatusHighText: 'Action required',
    riskStatusUnknownText: 'Unknown',
    riskStatusLowDesc: 'Your protection is optimized according to your current profile.',
    riskStatusMediumDesc: 'Review these suggestions to optimize your protection:',
    riskStatusHighDesc: 'Immediate attention is required to mitigate risks.',
    riskStatusUnknownDesc: 'Cannot determine protection status.',
    coverageLevelLabel: 'Estimated Coverage Level',
    viewRecommendationsButton: 'View Recommendations',
    simulateProfileButton: 'Simulate Other Profile',
    improveProtectionButton: 'Improve my Protection',
    currentEnvironmentTitle: 'Current Environment',
    weatherLocationText: (location: string) => `in ${location}`,
    yourLocation: 'your location',
    unknownLocation: 'unknown',
    weatherUnavailableText: 'Weather data not available.',
