  ...
  return (
    <div className="container mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {policies.map((policy) => (
          <Dialog key={policy.id} onOpenChange={(open) => { if (!open) setSelectedPolicy(null); setSimulatedPremium(null); }}>
            <DialogTrigger asChild>
             ...
             {/* Dialog Content is rendered outside the trigger card */}
          </Dialog>
        ))}
      </div>

      {/* Separate Dialog Content for Details */}
